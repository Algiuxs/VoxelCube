...
public abstract class ShaderProgram {
    ...
    protected void load2DVector(int loacation, Vector2f vector){
        GL20.glUniform2f(loacation, vector.x, vector.y);
    }

    protected void load3DVector(int loacation, Vector3f vector){
    ...
    private int loadshader(String file, int type){
        ...
        if(GL20.glGetShaderi(shaderID, GL20.GL_COMPILE_STATUS) == GL11.GL_FALSE) {
            ...
            System.out.println(GL20.glGetShaderSource(shaderID)+GL20.glGetShaderInfoLog(shaderID,10000));
